...
# Your API key - loaded from .env file automatically
LLM_API_KEY = _os.getenv("OPENAI_API_KEY", "")  # Set OPENAI_API_KEY in your .env file

# Model to use (leave empty for default, or specify like "gpt-4o", "claude-3-5-sonnet-20241022", etc.)
LLM_MODEL = "gpt-4o-mini"  # Using gpt-4o-mini as judge (faster and cheaper)
